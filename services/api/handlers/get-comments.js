...
const log = require("../../../common/logger")("API Service GET comment");
...
module.exports = function(){
  ...
  burrow.connect(process.env.RABBITMQ, "API Service GET comment")
    .then(function(){
  ...
  return function *(){
    try {
      ...
      this.body = yield burrow.rpc.call("get-comments", payload);
    } catch(err) {
      log.error(err);
      this.status = 500;
    }
